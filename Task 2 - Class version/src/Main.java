...
public class Main {
    ...
    public static void addCustomer() {
        ...
        try {
            ...
            System.out.println(customerFirstName + " has been successfully added to a queue.");
    ...
    /**
     Gets Minimum Length of the queue
     * */
    ...
    public static void storeData() {
        try{
            ...
            for(Customer customer1: queue1Customers){
                foodQueueFileWriter.write("Customer Name:" + customer1.getFirstName() + " " + customer1.getSecondName());
                foodQueueFileWriter.write(System.getProperty("line.separator"));
            ...
            for(Customer customer2: queue2Customers){
                foodQueueFileWriter.write("Customer Name:" + customer2.getFirstName() + " " + customer2.getSecondName());
                foodQueueFileWriter.write(System.getProperty("line.separator"));
            ...
            for(Customer customer3: queue3Customers){
                foodQueueFileWriter.write("Customer Name:" + customer3.getFirstName() + " " + customer3.getSecondName());
                foodQueueFileWriter.write(System.getProperty("line.separator"));
